...
export default function Location({navigation}) {
  ...
  let move = val => {
    navigation.navigate('appMap',val);
    // navigation.navigate('home', { screen: 'appMap' });
    // const unsubscribe = navigation.getParent().addListener('tabPress', (e) => {
    //   // Do something
    //   console.log(e);
    // return navigation.goBack("appMap");
  };
  return (
    <View style={[styles.bgWhite]}>
      <ScrollView>
      <View style={[ styles.paper, styles.bgPrimary]}><Text style={[styles.textWhite,      styles.textCenter,styles.p3]}>Total No of Countries : {list.length}</Text></View>
        {list.map((element, index) => (
          <TouchableOpacity
            key={index}
            style={[styles.p3, styles.paper, styles.bgWhite]}
            ...
            <Text style={[styles.textCenter, styles.textPrimary]}>
              Country Code: {element.country_code}
            </Text>
            <Text style={[styles.textCenter, styles.textPrimary]}>
        ...
        {/* <FlatList
          ...
          renderItem={element => (
            <TouchableOpacity
              index={element.index}
              style={[styles.p2, styles.paper]}>
              <Text style={styles.textCenter}> {element.item.name}</Text>
            </TouchableOpacity>
          )}
        /> */}
      </ScrollView>
